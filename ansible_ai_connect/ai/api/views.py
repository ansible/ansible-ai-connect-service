...
class AACSAPIView(APIView):
    def initialize_request(self, request, *args, **kwargs):
        ...
        # TODO: when we will also move the request_serializer block
        # we will change this line below. The model_id attribute should
        # be exposed as self.validated_data.model, or using a special
        # method.
