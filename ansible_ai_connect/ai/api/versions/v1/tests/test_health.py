...
class TestHealthChatbotView(APIVersionTestCaseBase, APITransactionTestCase):
    ...
    def test_health_check_chatbot_service(self, mock_session_factory):
        mock_session = mock.Mock()
        mock_response = BaseTestHealthCheck.mocked_requests_succeed(
    ...
    @mock.patch.object(ssl_manager.ssl_manager, "get_requests_session")
    def test_health_check_chatbot_service_error(self, mock_session_factory):
        mock_session = mock.Mock()
        mock_session.get.side_effect = HTTPError
        mock_session_factory.return_value = mock_session
