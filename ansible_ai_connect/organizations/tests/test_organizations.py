...
class TestOrganization(TestCase):
    def test_org_with_telemetry_schema_2_opted_in(self):
        organization = ExternalOrganization.objects.get_or_create(id=123, telemetry_opt_out=False)[0]
...
class TestOrganizationAPIKey(WisdomServiceAPITestCaseBaseOIDC):
    ...
    def test_org_has_api_key(self):
        organization = ExternalOrganization.objects.get_or_create(id=1981, telemetry_opt_out=False)[0]
