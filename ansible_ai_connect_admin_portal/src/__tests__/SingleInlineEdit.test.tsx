...
describe("SingleInlineEdit", () => {
  it("OnRender", async () => {
    ...
    const clearButtonElement = screen.getByTestId(
      "model-settings-editor__clear-button",
    );
  ...
  it("OnRender::Password", async () => {
    ...
    expect(textInputElement).toHaveAttribute("placeholder", "test-placeholder");
    expect(textInputElement).not.toBeDisabled();
    const toggleViewElement = screen.getByTestId(
      "model-settings-editor__toggleView",
    );
