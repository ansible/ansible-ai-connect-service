...
describe("ModelSettingsOverview", () => {
  ...
  it("Loading", async () => {
    ...
    expect(
      await screen.findByTestId("model-settings-overview__key-loading"),
    ).toBeInTheDocument();
    expect(
      await screen.findByTestId("model-settings-overview__model-id-loading"),
    ).toBeInTheDocument();
  });

  it("Loaded::Not found", async () => {
    ...
    expect(
      await screen.findByTestId("model-settings-overview__key-not-found"),
    ).toBeInTheDocument();
    expect(
      await screen.findByTestId("model-settings-overview__add-key-button"),
    ).toBeInTheDocument();

    expect(
      await screen.findByTestId("model-settings-overview__model-id-not-found"),
    ).toBeInTheDocument();
    expect(
      await screen.findByTestId("model-settings-overview__add-model-id-button"),
    ).toBeInTheDocument();
  });
  ...
  it("Loaded::Found", async () => {
    ...
    expect(
      await screen.findByTestId("model-settings-overview__key"),
    ).toBeInTheDocument();
    expect(
    ...
    expect(
      await screen.findByTestId("model-settings-overview__model-id"),
    ).toBeInTheDocument();
    expect(
  ...
  it("Add::Key", async () => {
    ...
    const addKeyButton = await screen.findByTestId(
      "model-settings-overview__add-key-button",
    );
  ...
  it("Update::Key", async () => {
    ...
    const updateKeyButton = await screen.findByTestId(
  ...
  it("Add::ModelId::APIKeyFound", async () => {
    ...
    const addModelIdButton = await screen.findByTestId(
  ...
  it("Add::ModelId::APIKeyNotFound", async () => {
    const wcaKey: WcaKey = { status: "SUCCESS_NOT_FOUND" };
    const wcaModelId: WcaModelId = { status: "SUCCESS_NOT_FOUND" };
  ...
  it("Update::ModelId", async () => {
    ...
    const updateModelIdButton = await screen.findByTestId(
      "model-settings-overview__update-model-id-button",
    );
  ...
  it("Validate::Key::Success", async () => {
    ...
    const testKeyButton = await screen.findByTestId(
  ...
  it("Validate::Key::Failure", async () => {
    ...
    const alert = await screen.findByTestId(
      "model-settings-overview__alert-key-invalid",
    );
    expect(alert).toBeInTheDocument();
  });

  it("Validate::Key::Failure::Error", async () => {
    const wcaKey: WcaKey = {
      status: "SUCCESS",
      data: { lastUpdate: new Date() },
    };
  ...
  it("Validate::ModelId::Success", async () => {
    const wcaKey: WcaKey = {
      status: "SUCCESS",
      data: { lastUpdate: new Date() },
    };
    ...
    const testModelIdButton = await screen.findByTestId(
  ...
  it("Validate::ModelId::Failure", async () => {
    const wcaKey: WcaKey = {
      status: "SUCCESS",
      data: { lastUpdate: new Date() },
    };
  ...
  it("Validate::ModelId::TrialExpired", async () => {
    const wcaKey: WcaKey = {
      status: "SUCCESS",
      data: { lastUpdate: new Date() },
    };
  ...
  it("Validate::ModelId::Failure::Error", async () => {
    const wcaKey: WcaKey = {
      status: "SUCCESS",
      data: { lastUpdate: new Date() },
    };
