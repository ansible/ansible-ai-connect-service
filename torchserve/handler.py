...
class TransformersClassifierHandler(BaseHandler):
    ...
    def initialize(self, ctx):
        ...
        self.model.eval()
        logger.debug(
            f"Transformer model from path {model_dir} and tokenizer {self.tokenizer} loaded"
        )
    ...
    def preprocess(self, data):
        ...
        tokenizer_kwargs = {"truncation": True, "max_length": self.model_size}
    ...
    def inference(self, inputs):
        ...
        print(
            ...
            f" and {sys.getsizeof(source_ids_.storage())}",
            sep="\n",
        )
