...
class CoreAnsibleWisdomExtServiceStub:
...
class CoreAnsibleWisdomExtServiceServicer:
    """Missing associated documentation comment in .proto file."""
...
class CoreAnsibleWisdomExtService:
    """Missing associated documentation comment in .proto file."""

    @staticmethod
    def ClassificationPredict(
        request,
        target,
        options=(),
