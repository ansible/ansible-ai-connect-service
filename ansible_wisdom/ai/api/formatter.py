...
"""
    contents = extra_empty_lines
    print(contents)
    print(normalize_yaml(contents))
    print(yaml.dump(normalize_yaml(contents)))

    extra_empty_spaces = """---

- name: test empty spaces
...
"""
    contents = extra_empty_spaces
    print(repr(contents))
    print(repr(yaml.dump(contents)))
    print(normalize_yaml(contents))
    print(repr(yaml.dump(normalize_yaml(contents))))
