...
ANSIBLE_LINT_TRANSFORM_CONFIG_OPTIONS = os.getenv('ANSIBLE_LINT_TRANSFORM_CONFIG_OPTIONS')
ANSIBLE_LINT_RULES_DIRECTORY = os.getenv('ANSIBLE_LINT_RULES_DIRECTORY')
