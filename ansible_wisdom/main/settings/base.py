...
AUTHZ_CIAM_SERVICE_RETRY_COUNT = int(os.getenv("CIAM_SERVICE_RETRY_COUNT", "3"))
...
CIAM_ORG_CACHE_TIMEOUT_SEC = int(os.environ.get('CIAM_ORG_CACHE_TIMEOUT_SEC', 60 * 60 * 24))
