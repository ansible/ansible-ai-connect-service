...
describe("ModelSettingsKey", () => {
  ...
  it("Loaded", async () => {
    ...
    expect(
      await screen.findByTestId("model-settings-editor__bread-crumbs"),
    ).toBeInTheDocument();
    expect(
      await screen.findByTestId("model-settings-editor__editor"),
    ).toBeInTheDocument();
    expect(
      await screen.findByTestId("model-settings-editor__save-button"),
    ).toBeInTheDocument();
    expect(
      await screen.findByTestId("model-settings-editor__cancel-button"),
    ).toBeInTheDocument();
  });
  ...
  it("Click::Save::Failure", async () => {
    ...
    const alert = await screen.findByTestId(
      "model-settings-editor__alert-invalid",
    );
  ...
  it("Click::Cancel", async () => {
    ...
    const cancelButton = await screen.findByTestId(
      "model-settings-editor__cancel-button",
    );
