    ...
    return (
        <PageFramework>
            <Page header={header} sidebar={<PageSidebar navigation={navigationItems}/>}>
                <PageLayout>
                    {hasSubscription && (
                        <PageDenied titleKey={"NoPermissionsTitle"} captionKey={"NoPermissionsContactOrgCaption"}/>
                    )}
                    {!hasSubscription && (
                        <PageDenied titleKey={"NoPermissionsNoSubscriptionTitle"} captionKey={"NoPermissionsNoSubscriptionContactOrgCaption"}/>
                    )}
                </PageLayout>
            </Page>
        </PageFramework>
